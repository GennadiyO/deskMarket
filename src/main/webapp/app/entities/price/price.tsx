      ...
      <div className="table-responsive">
        ...
        >
          {priceList && priceList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('priceId')}>
                    Price Id <FontAwesomeIcon icon="sort" />
                  </th>
              ...
              <tbody>
                {priceList.map((price, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{price.priceId}</td>
                    <td>
                      <TextFormat type="date" value={price.creationDate} format={APP_DATE_FORMAT} />
                    </td>
                    <td>{price.price}</td>
                    <td>{price.deskDeskId ? <Link to={`desk/${price.deskId}`}>{price.deskDeskId}</Link> : ''}</td>
            ...
            !loading && <div className="alert alert-warning">No Prices found</div>
          )}
        </InfiniteScroll>
      </div>
    </div>
