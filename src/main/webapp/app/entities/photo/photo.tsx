              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('photoId')}>
                    Photo Id <FontAwesomeIcon icon="sort" />
                  </th>
                ...
                {photoList.map((photo, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {photo.photo ? (
                        <div>
                          <a onClick={openFile(photo.photoContentType, photo.photo)}>
                            <img src={`data:${photo.photoContentType};base64,${photo.photo}`} style={{ maxHeight: '30px' }} />
                            &nbsp;
                          </a>
                          <span>
                            {photo.photoContentType}, {byteSize(photo.photo)}
                          </span>
                        </div>
                      ) : null}
                    </td>
                    <td>{photo.deskDeskId ? <Link to={`desk/${photo.deskId}`}>{photo.deskDeskId}</Link> : ''}</td>
